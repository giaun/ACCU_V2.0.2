...
//EnergyMonitor ct_senso[SL_TOTAL_CT_SENSOR];
...
public:
	...
	#define	slave_accu_ID						(3)
	uint8_t u8BufferSize;
	uint8_t au8Buffer[MAX_BUFFER];
	void begin(uint32_t u32baudrate);
	void begin();
	void init(uint8_t u8id, uint8_t u8txenpin, long u32baudrate);
